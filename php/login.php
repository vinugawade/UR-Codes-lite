                    ...
                    <div class="card-body">
                        ...
                        <form action="./Log-in.php" method='POST'>
                            ...
                            <div class="form-group">
                                ...
                                <input type='password' inputmode='password' name='password' placeholder="PASSWORD" class='form-control' required>
                            </div>
                            <div class="my-4">
                                <button type='submit' name='submit' class='btn btn-primary'><i class="fas fa-sign-in-alt"></i>&nbsp;LOGIN</button><br><br>
                                <a id="checkinput" href='./login.php' onclick="check()" class="text-muted text-center"><small>Forgot Password? Click Here</small></a>
                                ...
                                checkinput.addEventListener('click', () => {
                                    if (navigator.onLine) {
                                        if (document.getElementById('email').value != "") {
                                            document.getElementById('checkinput').href = "./forgot.php?email=" + document.getElementById('email').value;
                                        } else {
                    ...
                    <div class="card-body">
                        ...
                        <form action="./register.php" method="POST">
                            <div class="form-group">
                                ...
                                <input type='text' inputmode='text' name='full_name' placeholder="YOUR FULL NAME HERE" class='form-control' required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type='tel' inputmode='tel' pattern="[789][0-9]{9}" placeholder="PHONE NO" name='number' class='form-control' required>
                            </div>
                            <div class="form-group">
