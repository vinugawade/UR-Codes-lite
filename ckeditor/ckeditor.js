...
(function() {
        ...
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,
            d = {
                ...
                basePath: function() {
                    ...
                    if (!c)
                        for (var b = document.getElementsByTagName("script"), d = 0; d < b.length; d++) { var h = b[d].src.match(a); if (h) { c = h[1]; break } } - 1 == c.indexOf(":/") && "//" != c.slice(0, 2) && (c = 0 === c.indexOf("/") ? location.href.match(/^.*?:\/\/[^\/]*/)[0] +
                ...
                domReady: function() {
                    ...
                    return function(c) {
                        function k() {
                            try { document.documentElement.doScroll("left") } catch (c) { setTimeout(k, 1); return }
                            a()
                        }
                        b.push(c);
                        ...
                        if (1 == b.length)
                            ...
                            c = !1;
                            try { c = !window.frameElement } catch (f) {}
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return {
            ...
            on: function(b, d, f, l, h) {
                function k(a, z, w, e) { a = { name: b, sender: this, editor: a, data: z, listenerData: l, stop: w, cancel: e, removeListener: p }; return !1 === d.call(f, a) ? !1 : a.data }

                function p() { z.removeListener(b, d) }
                var e = a.call(this, b);
                if (0 > e.getListenerIndex(d)) {
                    ...
                    for (var w = e.length - 1; 0 <= w; w--)
                        if (e[w].priority <= h) return e.splice(w + 1, 0, k), { removeListener: p };
                    e.unshift(k)
                }
    ...
    (function() {
        ...
        var b = [],
            ...
            e = function(a, b) { return "#" == b[0] ? String.fromCharCode(parseInt(b.slice(1), 10)) : p[b] };
        ...
        CKEDITOR.tools = {
            ...
            htmlEncode: function(a) { return void 0 === a || null === a ? "" : String(a).replace(g, "\x26amp;").replace(f, "\x26gt;").replace(l, "\x26lt;") },
            ...
            transformPlainTextToHtml: function(a, b) {
                ...
                if (!e) {
                    ...
                    if (n.test(c)) var k = "\x3c" + h + "\x3e",
                        d = "\x3c/" + h + "\x3e",
                        c = k + c.replace(n, function() { return d + k }) + d
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
                e || (c =
                    c.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function(a) { return CKEDITOR.tools.repeat(a, 2) }));
            ...
            setTimeout: function(a, b, e, c, h) {
                h || (h = window);
                e || (e = h);
                return h.setTimeout(function() { c ? a.apply(e, [].concat(c)) : a.apply(e) }, b || 0)
            },
            ...
            indexOf: function(a, b) {
                if ("function" == typeof b)
                    for (var e = 0, c = a.length; e < c; e++) { if (b(a[e])) return e } else {
            ...
            cssLength: function() {
                var a = /^-?\d+\.?\d*px$/,
                    b;
                return function(e) { b = CKEDITOR.tools.trim(e + "") + "px"; return a.test(b) ? b : e || "" }
            }(),
            ...
            tryThese: function() { for (var a, b = 0, e = arguments.length; b < e; b++) { var c = arguments[b]; try { a = c(); break } catch (h) {} } return a },
            ...
            getStyledSpans: function(a, b) {
                ...
                return CKEDITOR.tools.array.filter(e, function(b) { return !!b.getStyle(a) })
            },
            fixDomain: function() {
            ...
            enableHtml5Elements: function(a, b) { for (var e = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "), c = e.length, h; c--;) h = a.createElement(e[c]), b && a.appendChild(h) },
            ...
            normalizeMouseButton: function(a, b) {
                ...
                for (var e = [
                    ...
                    ], c = 0; c < e.length; c++) { var h = e[c]; if (h[0] === a && b) return h[1]; if (!b && h[1] === a) return h[0] }
            },
            ...
            array: {
                filter: function(a, b, e) {
                    var c = [];
                    this.forEach(a, function(h, n) { b.call(e, h, n, a) && c.push(h) });
                    return c
                },
                find: function(a, b, e) {
                ...
                map: function(a, b, e) { for (var c = [], h = 0; h < a.length; h++) c.push(b.call(e, a[h], h, a)); return c },
                reduce: function(a,
                    b, e, c) { for (var h = 0; h < a.length; h++) e = b.call(c, e, a[h], h, a); return e },
                ...
                zip: function(a, b) { return CKEDITOR.tools.array.map(a, function(a, e) { return [a, b[e]] }) },
                unique: function(a) { return this.filter(a, function(b, e) { return e === CKEDITOR.tools.array.indexOf(a, b) }) }
            },
            object: {
                ...
                merge: function(a, b) {
                    var e = CKEDITOR.tools,
                        c = e.clone(a),
                        h = e.clone(b);
                    e.array.forEach(e.object.keys(h), function(a) { c[a] = "object" === typeof h[a] && "object" === typeof c[a] ? e.object.merge(c[a], h[a]) : h[a] });
                    return c
                }
            },
    ...
    CKEDITOR.dtd = function() {
        var a = CKEDITOR.tools.extend,
            d = function(a, b) { for (var c = CKEDITOR.tools.clone(a), h = 1; h < arguments.length; h++) { b = arguments[h]; for (var k in b) delete c[k] } return c },
            b = {},
            c = {},
            g = { address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, main: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1 },
    ...
    CKEDITOR.dom.domObject.prototype = function() {
        ...
        return {
            ...
            removeAllListeners: function() {
                ...
                } catch (g) { if (!CKEDITOR.env.edge || -2146828218 !== g.number) throw g; }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        ...
        getIndex: function(a) {
            ...
            do
                if (!a || b.equals(this) || b.type != CKEDITOR.NODE_TEXT || !g && !b.isEmpty()) c++, g = b.type == CKEDITOR.NODE_TEXT;
        ...
        getAscendant: function(a, d) {
            var b = this.$,
                c, g;
            d || (b = b.parentNode);
            "function" == typeof a ? (g = !0, c = a) : (g = !1, c = function(b) { b = "string" == typeof b.nodeName ? b.nodeName.toLowerCase() : ""; return "string" == typeof a ? b == a : b in a });
            for (; b;) { if (c(g ? new CKEDITOR.dom.node(b) : b)) return new CKEDITOR.dom.node(b); try { b = b.parentNode } catch (f) { b = null } }
            return null
        },
    ...
    (function() {
        function a(a, b) { return -1 < (" " + a + " ").replace(f, " ").indexOf(" " + b + " ") }
        ...
        function c(a) { for (var b = 0, c = 0, e = l[a].length; c < e; c++) b += parseFloat(this.getComputedStyle(l[a][c]) || 0, 10) || 0; return b }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            addClass: g ? function(a) { this.$.classList.add(a); return this } : function(b) {
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function n(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0 }!a && (a = this.getWindow());
                f = a.getDocument();
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return (!b || !N.equals(a)) && (!r || !a.equals(r)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)) }
            }
            var E = a ? this._.guardRTL : this._.guardLTR;
            h = z ? function(a, b) { return !1 === E(a, b) ? !1 : z(a, b) } : E;
        ...
        var g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
            ...
            k = function(a) { return l(a) || f(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty) };
        CKEDITOR.dom.walker.ignored =
            function(a) { return function(b) { b = f(b) || l(b) || h(b); return !!(a ^ b) } };
    ...
    (function() {
        ...
        function b() {
            ...
            return function(g) { return c(g) || b(g) ? !0 : d(g) && !a ? a = !0 : g.type == CKEDITOR.NODE_TEXT && (g.hasAscendant("pre") || CKEDITOR.tools.trim(g.getText()).length) || g.type == CKEDITOR.NODE_ELEMENT && !g.is(f) ? !1 : !0 }
        }

        function c(a) {
            var b = CKEDITOR.dom.walker.whitespaces(),
                c = CKEDITOR.dom.walker.bookmark(1);
            return function(d) { return c(d) || b(d) ? !0 : !a && l(d) || d.type == CKEDITOR.NODE_ELEMENT && d.is(CKEDITOR.dtd.$removeEmpty) }
        }

        function g(a) { return function() { var b; return this[a ? "getPreviousNode" : "getNextNode"](function(a) {!b && p(a) && (b = a); return k(a) && !(l(a) && a.equals(b)) }) } }
        var f = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 },
        ...
        CKEDITOR.dom.range.prototype = {
            ...
            createBookmark: function(a) {
                ...
                return { startNode: a ? h + (f ? "C" : "S") : g, endNode: a ? h + "E" : n, serializable: a, collapsed: f }
            },
            createBookmark2: function() {
                function a(b) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && 0 < d) {
                        a: {
                            for (f = e; d--;)
                                if (g = f.getChild(d).getIndex(!0), 0 <= g) { d = g; break a }
                            d = -1
                        }
                        d += 1
                    }
                ...
                return function(c) {
                    ...
                    c && (a(f), b(f, this.root),
                        d || (a(n), b(n, this.root)));
                    return { start: f.container.getAddress(c), end: d ? null : n.container.getAddress(c), startOffset: f.offset, endOffset: n.offset, normalized: c, collapsed: d, is2: !0 }
                }
            }(),
            ...
            enlarge: function(a, b) {
                ...
                switch (a) {
                                        ...
                                        if (M && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            ...
                                            if (d.test(N)) m = null;
                                                ...
                                                for (var r = m.$.getElementsByTagName("*"), E = 0, D; D = r[E++];)
                                                    if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) { m = null; break }
                                            m && (A = !!N.length)
                                        } else m = null;
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var u, S, T = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                            t = null,
                            P = function(a) {
                            ...
                            f = function(a) { var b = P(a);!b && a.is && a.is("br") && (S = a); return b };
                        k.guard = P;
                        k = k.lastBackward();
                        u = u || h;
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            k.evaluator = function(a) { return !J(a) && !v(a) };
            ...
            splitBlock: function(a, b) {
                ...
                return { previousBlock: f, nextBlock: g, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n }
            },
    ...
    (function() {
        ...
        function b(a, c, f, g) {
            ...
            if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(c)) return b(a,
                c, f, g.remaining);c = new CKEDITOR.dom.range(g.element);c.selectNodeContents(g.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = { element: g.element, container: f, remaining: g.remaining, iterator: c };
            return 1
        }
        ...
        a.prototype = {
                ...
                for (this._.nextNode = null; n;) {
                    ...
                    if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0);
                        ...
                        if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) {
                            ...
                            b(this, a, d);
                            break
                        } else if (n.isBlockBoundary(this.forceBrBreak && !x && { br: 1 })) {
                            if ("br" == m) I = 1;
            ...
            _getNextSourceNode: function(a, b, c) {
                function d(a) { return !(a.equals(c) || a.equals(g)) }
                var g =
                    this.range.root;
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (e in b) {
                g = b[e];
                g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : E(g);
        ...
        function e(a) {
            var b, c, d, f, e = {},
                g = 1;
            for (a = D(a); b = a.match(t);)(c = b[2]) ? (d = z(c, "styles"), f = z(c, "attrs"), c = z(c, "classes")) : d = f = c = null, e["$" + g++] = { elements: b[1], classes: c, styles: d, attributes: f }, a = a.slice(b[0].length);
            return e
        }

        function z(a, b) { var c = a.match(P[b]); return c ? D(c[1]) : null }
        ...
        function y(a, b, f, e) {
            ...
            if (e.doFilter) {
                a: {
                    ...
                    h = e.skipRequired;
                    var l = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 },
                        u, E;
                    if (a || r) {
                        w(b);
                        if (t)
                            for (u = 0, E = t.length; u < E; ++u)
                                if (!1 === c(t[u], b, l)) { a = null; break a }
                        if (D)
        ...
        function H(a) { if (!a) return !1; if (!0 === a) return !0; var b = G(a); return function(c) { return c in a || b && c.match(b) } }

        function x() { return new CKEDITOR.htmlParser.element("br") }
        ...
        function K(a, b, c) {
            var d = a.name;
            if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(x()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove());
        ...
        function m(a, b, c) {
            ...
            for (d = 0; d < c.length; ++d)
                if (f = c[d], !(f.check && !a.check(f.check, !1) || f.left && !f.left(b))) { f.right(b, B); break }
        }
        ...
        function F(a, b) {
            ...
            for (e in d)
                if ("class" == e)
                    for (c = d[e].split(/\s+/), m = a.classes.join("|"); v = c.pop();) { if (-1 == m.indexOf(v)) return !1 } else if (a.attributes[e] != d[e]) return !1;
            for (g in f)
                if (a.styles[g] !=
                    f[g]) return !1;
            return !0
        ...
        function M(a, b) { var c, d; "string" == typeof a ? c = a : a instanceof CKEDITOR.style ? d = a : (c = a[0], d = a[1]); return [{ element: c, left: d, right: function(a, c) { c.transform(a, b) } }] }

        function A(a) { return function(b) { return F(b, a) } }
        ...
        CKEDITOR.filter.prototype = {
            allow: function(b, c, d) {
                ...
                if ("string" == typeof b) b = e(b);
                    ...
                    b = {};
                    d = g.attributes;
                    b[g.element] = g = { styles: g.styles, requiredStyles: g.styles && CKEDITOR.tools.object.keys(g.styles) };
                ...
                } else if (CKEDITOR.tools.isArray(b)) { for (g = 0; g < b.length; ++g) m = this.allow(b[g], c, d); return m }
                ...
                if (!this.disabled && a) {
                    ...
                    for (f = 0; f < a.length; ++f) {
                        ...
                        for (g = 0; g < b.length; ++g) m = b[g], "string" == typeof m ? (m = m.split(/\s*:\s*/), v = m[0], t = null, r = m[1]) : (v = m.check, t = m.left, r = m.right), e || (e = m, e = e.element ? e.element : v ? v.match(/^([a-z0-9]+)/i)[0] :
                            e.left.getDefinition().element), t instanceof CKEDITOR.style && (t = A(t)), c.push({ check: v == e ? null : v, left: t, right: "string" == typeof r ? N(r) : r });
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                    }
            ...
            check: function(a, b, c) {
                ...
                } else f = a.getDefinition(), v = f.styles, d = f.attributes || {}, v && !CKEDITOR.tools.isEmpty(v) ? (v = E(v), d.style = CKEDITOR.tools.writeCssText(v, !0)) : v = {}, f = { name: f.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: v, children: [] };
                ...
                y(this, v, t, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c });
        ...
        var S = { styles: 1, attributes: 1, classes: 1 },
            T = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" },
        ...
        CKEDITOR.focusManager.prototype = {
            ...
            add: function(a, d) {
                ...
                if (!b || b != this) {
                    ...
                    var g = { blur: function() { a.equals(this.currentActive) && this.blur() }, focus: function() { this.focus(a) } };
                    a.on(b, g.focus, this);
                    a.on(c, g.blur, this);
    ...
    (function() {
        var a, d = function(b) {
                ...
                a || (f && (a = !1 !== l.execCommand(f, { from: "keystrokeHandler" })), a || (a = !!this.blockedKeystrokes[d]));
        ...
        return {
            load: function(b, c, g, f) {
                ...
                var h = b.length,
                    ...
                    p = [],
                    e = [],
                    z = function(a) { c && (l ? c.call(g, a) : c.call(g, p, e)) };
                if (0 === k) z(!0);
                else {
                    var w = function(a, b) {
                            (b ? p : e).push(a);
                        ...
                        G = function(b) {
                            if (a[b]) w(b, !0);
                                ...
                                if (!(1 < f.length)) {
                                    ...
                                    c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function() { if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, y(b, !0) } : (e.$.onload = function() {
                                        setTimeout(function() {
                                            e.$.onload = null;
                                            e.$.onerror = null;
                                            y(b, !0)
                    ...
                    a.call(this, b, function(a) {
                        ...
                        for (e in a) {
                            ...
                            if (!d[e]) {
                                ...
                                h.isSupportedEnvironment = h.isSupportedEnvironment || function() { return !0 };
                                d[e] = 1
                            }
                            if (w)
                                for (w.split && (w =
    ...
    (function() {
        function a(a, e, g) {
            ...
            this.on("activeFilterChange", function() { f(this, this.elementPath(), !0) });
            this.on("mode", c);
            ...
            CKEDITOR.fire("instanceCreated",
                null, this);
            CKEDITOR.add(this);
            CKEDITOR.tools.setTimeout(function() { this.isDestroyed() || this.isDetached() || h(this, a) }, 0, this)
        }
        ...
        function f(a, b, c) { if (b) { var d, f, e = a.commands; for (f in e) d = e[f], (c || d.contextSensitive) && d.refresh(a, b) } }
        ...
        function k(a) { CKEDITOR.skin.loadPart("editor", function() { p(a) }) }
            ...
            CKEDITOR.plugins.load(d.split(","),
                function(b) {
                    ...
                    for (var g in b) {
                        ...
                        if (t && (P = t.match(h)))
                            for (; t = P.pop();) CKEDITOR.error("editor-plugin-required", { plugin: t.replace(",", ""), requiredBy: g });
        ...
        function y(a, b) {
            ...
            for (var f = new CKEDITOR.dom.documentFragment, e, g, h, l = 0; l < a.length; l++) {
                ...
                c(k) ? (e || (e = r.getAscendant("table").clone(), e.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), f.append(e), e = e.findOne("thead, tbody, tfoot")), g && g.equals(r) || (g = r, h = r.clone(), e.append(h)), h.append(d(k))) :
        ...
        CKEDITOR.htmlParser.prototype = {
            ...
            parse: function(b) {
                for (var c, g, f = 0, l; c = this._.htmlPartsRegex.exec(b);) {
                    ...
                    if (g = c[1])
                        if (g = g.toLowerCase(), l && CKEDITOR.dtd.$cdata[g] && (this.onCDATA(l.join("")), l = null), !l) { this.onTagClose(g); continue }
                    if (l) l.push(c[0]);
                    else if (g = c[3]) {
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(f, l, h) {
                ...
                function p() { for (; H.length;) z(H.shift(), x) }
                ...
                function y(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || "dt" == a && "dd" == b || "dd" == a && "dt" == b : !1 }
                ...
                G.onTagOpen = function(f, e, g, h) {
                    ...
                    if (a(e)) n.push(e);
                        ...
                        if ("pre" == f) K = !0;
                        else { if ("br" == f && K) { x.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == f && (I = !0) }
                        if ("br" == f) H.push(e);
                        else {
                ...
                G.onTagClose = function(a) {
                    for (var b = n.length - 1; 0 <= b; b--)
                        if (a == n[b].name) { n.splice(b, 1); return }
                ...
                G.onCDATA =
                    function(a) { x.add(new CKEDITOR.htmlParser.cdata(a)) };
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            ...
            forEach: function(a, b, c) { if (!(c || b && this.type != b)) var d = a(this); if (!1 !== d) { c = this.children; for (var g = 0; g < c.length; g++) d = c[g], d.type == CKEDITOR.NODE_ELEMENT ? d.forEach(a, b) : b && d.type != b || a(d) } },
    ...
    (function() {
        ...
        function d(b, c, d, f) { var l, h; for (l in c)(h = b[l]) || (h = b[l] = new a), h.add(c[l], d, f) }
            ...
            proto: {
                ...
                onElement: function(a, c) {
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], f, l = 0; 3 > l; l++)
                        if (f = d[l]) { f = f.exec(a, c, this); if (!1 === f) return null; if (f && f != c) return this.onNode(a, f); if (c.parent && !c.name) break }
                    return c
                },
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, d) {
                for (var f = [this.findIndex(c), 0], l = 0, h = a.length; l < h; l++) f.push({ value: a[l], priority: c, options: d });
    ...
    (function() {
        ...
        function c(a) { for (a = a.previous; a && g(a);) a = a.previous; return a }
        ...
        function e(a, b) { return a.replace(b, function(a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + y(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) }

        function z(a) { return a.replace(T, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function y(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function(a, b) { return decodeURIComponent(b) }) }
        ...
        function q(a, b) {
            ...
            for (var g = 0; g < d.length; g++) a = a.replace(d[g], function(a) { a = a.replace(e, function(a, b, d) { return c[d] }); return /cke_temp(comment)?/.test(a) ? a : "\x3c!--{cke_temp}" + (c.push(a) - 1) + "--\x3e" });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, f) { return "\x3c" + c + d + "\x3e" + G(y(f), b) + "\x3c/" + c + "\x3e" })
        }
        var n;
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (b in CKEDITOR.dtd.$editable)
                for (var c = CKEDITOR.document.getElementsByTag(b), g = 0, f = c.count(); g < f; g++) a = c.getItem(g), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = { element: a, config: {} }, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
        };
    ...
    (function() {
        ...
        CKEDITOR.appendTo = function(b, d, f) { return a(b, d, f, CKEDITOR.ELEMENT_MODE_APPENDTO) };
        CKEDITOR.replaceAll = function() {
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                var d = null,
                    l = a[b];
                if (l.name || l.id) {
                    if ("string" == typeof arguments[0]) { if (!(new RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)")).test(l.className)) continue } else if ("function" == typeof arguments[0] && (d = {}, !1 === arguments[0](l, d))) continue;
                    this.replace(l, d)
                }
            }
        };
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, l) {
            ...
            l = l ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner") }) : h;
    ...
    (function() {
        ...
        function k(a) { a && a.isEmptyInlineRemoveable() && a.remove() }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertElementIntoRange: function(a, b) {
                    ...
                    b.deleteContents(1);
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({ tr: 1, table: 1, tbody: 1, thead: 1, tfoot: 1 }) ? H(b) : b.startContainer.is(CKEDITOR.dtd.$list) && x(b));
                    var g, h;
                    if (f)
                        for (;
                ...
                setup: function() {
                    ...
                    this.attachListener(a, "beforeGetData", function() {
                        var b =
                            this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(q, function(a, b) { return b }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller &&
                            this.attachListener(this, "keyup", function(b) { b.data.getKeystroke() in k && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select()) });
        ...
        n = function() {
            ...
            function f(b) { return b && a(b) && (b.is(D.$removeEmpty) || b.is("a") && !b.isBlockBoundary()) }
            ...
            return function(t, u, J, v) {
                ...
                if (!v.checkReadOnly()) {
                    ...
                    u = { type: u, dontFilter: C, editable: t, editor: B, range: v, blockLimit: z, mergeCandidates: [], zombies: [] };
                    var C = u.range,
                        z = u.mergeCandidates,
                        L = "html" === u.type,
                        q, w, y, x, G, V;
                    ...
                    if (t = J) {
                        ...
                        J = u.editor.dataProcessor.toHtml(J, { context: null, fixForBody: !1, protectedWhitespaces: !!H, dontFilter: u.dontFilter, filter: u.editor.activeFilter, enterMode: u.editor.activeEnterMode });
                    ...
                    if (t) {
                        ...
                        for (E(B, Q); V < B.length; V++) {
                            C = B[V];
                            if (L = C.isLineBreak) L = Q, q = v, x = y = void 0, C.hasBlockSibling ? L = 1 : (y = L.startContainer.getAscendant(D.$block, 1)) && y.is({ div: 1, p: 1 }) ? (x = y.getPosition(q), x ==
                    ...
                    if (!u.dontMoveCaret) {
                        for (O = e(R); O && a(O) && !O.is(D.$empty);) {
                            if (O.isBlockBoundary()) R.moveToPosition(O, CKEDITOR.POSITION_BEFORE_END);
                                ...
                                if (f(O) && O.getHtml().match(/(\s|&nbsp;)$/g)) { Y = null; break }
                                Y = R.clone();
    ...
    (function() {
        ...
        function k(a) { return M(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 }
        ...
        function w(a, b) { return b ? a.replace(I, function(a, b) { return b ? " " : "" }) : a.replace(x, "") }
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            c.on("contentDom", function() {
                ...
                k.attachListener(k, "mousedown", function() { E = 0 });
                ...
                if (CKEDITOR.env.ie && !p) {
                    var w;
                    k.attachListener(k, "mousedown", function(a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (w = c.window.getScrollPosition())) });
                        ...
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                            ...
                            m.on("mousedown", function(a) {
                                ...
                                if (a.getTarget().is("html") && a.$.y < m.$.clientHeight && a.$.x < m.$.clientWidth) {
                                    y = r.$.createTextRange();
                                    try { y.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) {}
                                    x =
                                        y.duplicate();
                                    m.on("mousemove", b);
                                    h.on("mouseup", c);
                ...
                if (p && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    var A;
                    k.attachListener(k, "mousedown", function() { A = 1 });
            ...
            c.on("key", function(a) { if ("wysiwyg" == c.mode) { var b = c.getSelection(); if (b.isFake) { var d = A[a.data.keyCode]; if (d) return d({ editor: c, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
        });
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: w, _createFillingCharSequenceNode: e, FILLING_CHAR_SEQUENCE: x });
        CKEDITOR.dom.selection.prototype = {
            getNative: function() { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = n ? this.document.$.selection : this.document.getWindow().$.getSelection() },
            getType: n ? function() {
                var a = this._.cache;
            ...
            getRanges: function() {
                var a = n ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        for (; 0 < h;) try { g = f[0 < m ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, p = g), f = g } catch (n) { return { container: d, offset: a(f) } }
            ...
            selectRanges: function(a) {
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (k) this.fake(k);
                        else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !K && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) g.call(this, a);
                        else {
                            if (n) {
                                ...
                                for (C = 0; C < a.length; C++) {
                                    ...
                                    try { B.setEnd(b.endContainer.$, b.endOffset) } catch (w) {
    ...
    (function() {
            ...
            if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END);
                ...
                for (w.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (w = 0); w;) {
                    ...
                    if (w.equals(r)) w = null, k = !0;
                        ...
                        if (u && w.data("cke-bookmark") || w.type === CKEDITOR.NODE_COMMENT) { w = w.getNextSourceNode(!0); continue }
                    ...
                    if (k && z && !z.collapsed) {
                        for (var k = H(this, e), y = k.hasAttributes(), x = z.getCommonAncestor(),
                                u = {}, E = {}, F = {}, I = {}, X, W, Y; k && x;) {
                            if (x.getName() == f) { for (X in h.attributes) !I[X] && (Y = x.getAttribute(W)) && (k.getAttribute(X) == Y ? E[X] = 1 : I[X] = 1); for (W in h.styles) !F[W] && (Y = x.getStyle(W)) && (k.getStyle(W) == Y ? u[W] = 1 : F[W] = 1) }
                            x = x.getParent()
                        }
        ...
        function I(a, b) { for (var c in a) a[c] = a[c].replace(E, function(a, c) { return b[c] }) }
        ...
        CKEDITOR.style.prototype = {
            ...
            applyToRange: function(a) { this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? f : null; return this.applyToRange(a) },
            ...
            applyToObject: function(a) { x(a, this) },
            ...
            checkElementMatch: function(a, b) {
                ...
                if ("string" == typeof this.element ?
                    ...
                    if (c._length) {
                        for (var h in c)
                            if ("_length" != h)
                                if (d = a.getAttribute(h) || "", "style" == h ? F(c[h], d) : c[h] == d) { if (!b) return !0 } else if (b) return !1;
                        if (b) return !0
                    } else return !0
                }
                return !1
    ...
    (function() {
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function() {
            ...
            f && (f = b.clone(), b.shrink(CKEDITOR.SHRINK_TEXT, !1, { skipBogus: !CKEDITOR.env.webkit }), d = !1, a(g, b, f), b.select(), d = !0)
        }
    })();
    (function() {
        function a(a, c) { b(a) ? a = Math.round(c * (parseFloat(a) / 100)) : "string" === typeof a && a.match(/^\d+$/gm) && (a = parseInt(a, 10)); return a }

        function d(a, c) { b(a) ? a = c * (parseFloat(a) / 100) : "string" === typeof a && a.match(/^\d?\.\d+/gm) && (a = parseFloat(a)); return a }

        function b(a) { return "string" === typeof a && a.match(/^((\d*\.\d+)|(\d+))%{1}$/gm) }

        function c(a, b, c) { return !isNaN(a) && a >= b && a <= c }

        function g(a) { a = a.toString(16); return 1 == a.length ? "0" + a : a }
        CKEDITOR.tools.color = CKEDITOR.tools.createClass({
            ...
            proto: {
                getHex: function() { if (!this._.isValidColor) return this._.defaultValue; var a = this._.blendAlphaColor(this._.red, this._.green, this._.blue, this._.alpha); return this._.formatHexString(a[0], a[1], a[2]) },
                getHexWithAlpha: function() { if (!this._.isValidColor) return this._.defaultValue; var a = Math.round(this._.alpha * CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE); return this._.formatHexString(this._.red, this._.green, this._.blue, a) },
                getRgb: function() {
                ...
                getRgba: function() { return this._.isValidColor ? this._.formatRgbString("rgba", this._.red, this._.green, this._.blue, this._.alpha) : this._.defaultValue },
                getHsl: function() {
                    if (!this._.isValidColor) return this._.defaultValue;
                    var a = this._.blendAlphaColor(this._.red, this._.green, this._.blue, this._.alpha),
                ...
                getHsla: function() { if (!this._.isValidColor) return this._.defaultValue; var a = this._.rgbToHsl(this._.red, this._.green, this._.blue); return this._.formatHslString("hsla", a[0], a[1], a[2], this._.alpha) },
            ...
            _: {
                ...
                formatHslString: function(a, b, c, d, g) { return a + "(" + b + "," + c + "%," + d + "%" + (void 0 !== g ? "," + g : "") + ")" },
                ...
                matchStringToNamedColor: function(a) { return CKEDITOR.tools.color.namedColors[a.toLowerCase()] || null },
                ...
                hex3ToHex6: function(a) { a = a.split(""); return "#" + a[1] + a[1] + a[2] + a[2] + a[3] + a[3] },
                extractColorChannelsByPattern: function(a, b) {
                    var c = a.match(b);
                    if (!c) return null;
                    c = c[2].split(",");
                    return c = CKEDITOR.tools.array.map(c, function(a) { return CKEDITOR.tools.trim(a) })
                },
                ...
                if (k.type == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (!l && (p = k.getName(),
                        ...
                        if (p = !f && "div" == p) {
                            a: {
                                p = k.getChildren();
                                for (var e = 0, z = p.count(); e < z; e++) { var w = p.getItem(e); if (w.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[w.getName()]) { p = !0; break a } }
                                p = !1
                            }
                            p = !p
                        }
    ...
    CKEDITOR.dom.elementPath.prototype = {
        ...
        contains: function(a, d, b) {
            ...
            a instanceof CKEDITOR.dom.element ? g = function(b) { return b.equals(a) } : CKEDITOR.tools.isArray(a) ? g = function(b) { return -1 < CKEDITOR.tools.indexOf(a, b.getName()) } : "function" == typeof a ? g = a : "object" == typeof a && (g = function(b) {
                return b.getName() in
                    a
            });
            var f = this.elements,
    ...
    (function() {
        ...
        var d = {
            ...
            createBookmarks: function(b) { for (var c = [], d, f = 0; f < this.length; f++) { c.push(d = this[f].createBookmark(b, !0)); for (var l = f + 1; l < this.length; l++) this[l] = a(d, this[l]), this[l] = a(d, this[l], !0) } return c },
            createBookmarks2: function(a) {
                for (var c = [], d = 0; d <
            ...
            if (!CKEDITOR.env.ie || !CKEDITOR.env.quirks) {
                ...
                a = function(a) {
                    ...
                    if (!a.getById("cke_ui_color")) {
                        var d = c(a);
                        h.push(d);
                        b.on("destroy", function() { h = CKEDITOR.tools.array.filter(h, function(a) { return d !== a }) });
    ...
    (function() {
            ...
            CKEDITOR.dialog.validate = {
                ...
                inlineStyle: function(a) {
                    return this.functions(function(a) {
                        ...
                        "" === a[a.length - 1] && a.pop();
                        return CKEDITOR.tools.array.every(a, function(a) { return f.test(CKEDITOR.tools.trim(a)) })
                    }, a)
                },
        ...
        CKEDITOR.plugins.add("dialog", {
            ...
            init: function(a) {
                ...
                a.on("doubleclick", function(b) { b.data.dialog && a.openDialog(b.data.dialog) },
                    null, null, 999)
            }
        })
    })();
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                this.modes ? (p = {}, a.on("beforeModeUnload", function() { a.mode && this._.state != CKEDITOR.TRISTATE_DISABLED && (p[a.mode] = this._.state) }, this), a.on("activeFilterChange", c, this), a.on("mode", c, this), !this.readOnly && a.on("readOnly", c, this)) : d && (d = a.getCommand(d)) && (d.on("state", function() { this.setState(d.state) },
